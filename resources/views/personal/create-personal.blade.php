                    ...
                    <h3 class="panel-heading panel-heading-with-position text-center">
                        ...
                        <div class="position-right">
                            <div class="block-switch">
                                <input id="toggle-flat" class="toggle toggle-flat" type="checkbox" name="active_status">
                        ...
                        <form role="form" method="POST" action="{{ route('personal-create') }}" class="form_with_amount">
                            ...
                            <div class="row">
                                <div class="col-md-6 form-group{{ $errors->has('target_amount') ? ' has-error' : '' }}">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input id="target_amount" type="number" class="form-control amount" placeholder="Target Amount" name="target_amount" value="{{ old('target_amount') }}">
                            ...
                            <div class="row">
                                <div class="col-md-6 form-group{{ $errors->has('recurrence') ? ' has-error' : '' }}">
                                    ...
                                    <select name="recurrence" data-placeholder="Select Savings Interval" class="form-control">
                                ...
                                <div class="col-md-6 form-group{{ $errors->has('priority') ? ' has-error' : '' }}">
                                    ...
                                    <select name="priority" data-placeholder="Set Priority Level" class="form-control" title="Set How Important it is to reach the Target">
