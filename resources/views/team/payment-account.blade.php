<div class="section tab-pane active" id="payment-account">
    <div class="col-sm-6 border-right">
        ...
        <div class="text-center text-sm alert alert-warning">This Account <b>MUST</b> be set for Etibe to start. <br />To confirm the Account, <b>100 NGN</b> will be debitted initially and added to your Personal Savings.</div>
    ...
    <div class="col-sm-6">
        ...
        <button class="btn btn-success btn-lg btn-block" type="button" value="Add Now!" data-toggle="modal" data-target="#add-crediting-account-modal">
            <i class="fa fa-plus-circle fa-lg"></i> Add Now!
        </button>
    </div>
</div>
