<div class="section tab-pane" id="invite-members">
    <h3 class="box-title text-center invite-heading margin-bottom-md">Invite Members<br /></h3>
    <!-- /.box-header -->
    <div class="box-body">
        <div class="col-md-8 col-md-offset-2">
            <form method="POST" action="{{ url('teams/'. $team->id .'/invite-members') }}" id="add_users_one_at_a_time">
                ...
                <h5 class="text-info text-center">You Can invite up to Five (5) Persons at a time Individually<br />To invite several persons at once, use the <code>Bulk Invite</code> link</h5>
