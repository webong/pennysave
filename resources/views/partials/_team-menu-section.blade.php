<div class="panel-body">
    <ul class="nav nav-pills nav-stacked">
        <li class="@if(! $payment_account) active @endif"><a href="#payment-account" data-toggle="pill">&#x20A6; &nbsp; Payment Account</a></li>
        <li class="@if($payment_account) active @endif"><a href="#team-statusboard" data-toggle="pill"><i class="fa fa-dashboard"></i> &nbsp; Team Statusboard</a></li>
