                ...
                <div class="section">
                    ...
                    <div class="panel-body">
                        @if ($user->group->count() > 0)
                                ...
                                <a href="{{ url('/teams/' . $group->id) }}" class="no-underline">
                                    <div class="thumbnail">
                                        <div class="caption bg-white">
                                            <div class="group-caption text-center">
                                            ...
                                            <div class="thumbnail-footer">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-7">
                                                        <h2 class="text-center">{{ number_format($group->amount) }}<small><sup>/Month</sup></small></h2>
                                                    </div>
                                                </div>
                            ...
                            @endforeach
                        @else
                            <h4 class="text-center">You Do Not Have Any Teams Yet</h4>
                                        ...
                                        <div class="thumbnail">
                                            <div class="caption bg-white">
                                                <div class="text-center">
                                                    ...
                                                    <div class="percent-area padding-bottom-xs">
